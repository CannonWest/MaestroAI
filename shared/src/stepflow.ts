 ...
 * 
 * This implementation converts between ConvChain Studio's visual graph format
...
/**
 * Maps ConvChain node types to Stepflow component paths
 */
...
/**
 * Converts a ConvChain Studio workflow to Stepflow YAML/JSON format
 */
export function convertToStepflow(workflow: Workflow): StepflowWorkflow {
  ...
  return {
    schema: 'https://stepflow.org/schemas/v1/flow.json',
    name: workflow.name,
    description: `Generated from ConvChain Studio workflow: ${workflow.name}`,
...
/**
 * Converts a single ConvChain node to a Stepflow step
 */
...
/**
 * Converts a Stepflow workflow to ConvChain Studio format
 */
...
export function toStepflowYAML(workflow: Workflow): string {
  ...
  yaml += `# Generated by ConvChain Studio\n`;
...
/**
 * Validates that a ConvChain workflow can be converted to Stepflow
 */
